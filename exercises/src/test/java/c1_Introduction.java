...
class c1_Introduction extends IntroductionBase {
    ...
    @Test
    void hello_world() {
        final Mono<String> serviceResult = hello_world_service();

        final String result = serviceResult.block();
    ...
    void unresponsive_service() {
        Exception exception = assertThrows(IllegalStateException.class, () -> {
            ...
            final String result = serviceResult.block(Duration.of(1, ChronoUnit.SECONDS));
        });
    ...
    @Test
    void empty_service() {
        final Mono<String> serviceResult = emptyService();

        final Optional<String> optionalServiceResult = serviceResult.blockOptional();
    ...
    void multi_result_service() {
        ...
        final String result = serviceResult.blockFirst();
    ...
    void fortune_top_five() {
        final Flux<String> serviceResult = fortuneTop5();

        final List<String> results = serviceResult.toStream().toList();
    ...
    void nothing_happens_until_you_() throws InterruptedException {
        final CopyOnWriteArrayList<String> companyList = new CopyOnWriteArrayList<>();
    ...
    void leaving_blocking_world_behind() throws InterruptedException {
        final AtomicReference<Boolean> serviceCallCompleted = new AtomicReference<>(false);
        final CopyOnWriteArrayList<String> companyList = new CopyOnWriteArrayList<>();
